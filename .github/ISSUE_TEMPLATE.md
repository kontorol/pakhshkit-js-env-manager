...
##### Prerequisites
- [ ] Have you checked for duplicate [issues](https://github.com/kontorol/pakhshkit-js-ima/issues): ______
- [ ] Which Plugin [version](https://github.com/kontorol/pakhshkit-js-ima/releases) are you using: ______
